...
function M.setup()
    ...
    local highlights = {
        ...
        Keyword     = { fg = colors.gold },
        Conditional = { fg = colors.gold },
        Repeat      = { fg = colors.gold },
        Label       = { fg = colors.gold },
        Exception   = { fg = colors.gold },
        ...
        ["@keyword"]              = { fg = colors.gold },
        ["@keyword.function"]     = { fg = colors.gold,   italic = true },
        ["@keyword.return"]       = { fg = colors.gold },
        ["@keyword.import"]       = { fg = colors.amber },
        ["@keyword.operator"]     = { fg = colors.gold },
        ["@keyword.modifier"]     = { fg = colors.gold },
        ["@keyword.conditional"]  = { fg = colors.gold },
        ["@keyword.repeat"]       = { fg = colors.gold },
        ["@keyword.exception"]    = { fg = colors.gold },
